...
<ul>
  ...
  You can long press the OK button in it to save the message without auto-adding the trailing period,
  while also keeping all the existing trailing punctuation 
  (so you can long press the generate button to continue this line mid-sentence).</li>
