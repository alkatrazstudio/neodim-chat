...
class Message {
  ...
  static String format(String text, {bool upperFirst = true, bool endWithDot = true}) {
    ...
    text = text.replaceAllMapped(RegExp(r'\b(can|won|don|shouldn|wouldn|mustn|didn|aren|isn)(t)\b', caseSensitive: false), (m) => "${m[1]}'${m[2]}");
    ...
    text = text.replaceAllMapped(RegExp(r'\b(m)(r|s|rs)\.?', caseSensitive: false), (m) => '${m[1]?.toUpperCase()}${m[2]}.');
